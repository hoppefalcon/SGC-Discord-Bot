...
public class UserPOTWActivityReportCommand implements Command {
        ...
        public void handle(SlashCommandInteraction slashCommandInteraction) {
                ...
                slashCommandInteraction.respondLater().thenAccept(interactionOriginalResponseUpdater -> {
                        ...
                        interactionOriginalResponseUpdater.setContent(
                                        String.format("Building a SGC POTW Report from %s to %s for %s",
                        ...
                        try {
                                ...
                                if (RaidReportTool.isValidDateFormat(startDateStr)
                                        ...
                                        if (durationInDays > 7) {
                                                ...
                                                int userPOTWScore = RaidReportTool.getUserPOTWScore(
                                                                userBungieId,
                                                                startDate,
                                                                endDate);
                                                ...
                                                if (userPOTWScore == -1) {
                                                        new MessageBuilder().setContent(String.format(
                                                                        "SGC POTW Report from %s to %s for %s",
                                                                        startDate.toString(),
                                                                        endDate.toString(),
                                                                        userBungieId))
                                                                        .addEmbed(new EmbedBuilder()
                                                        ...
                                                        LOGGER.info("Sending SGC POTW Report to "
                                                        ...
                                                        new MessageBuilder()
                                                                        ...
                                                                        .addEmbed(new EmbedBuilder()
                                                                                        .setAuthor(slashCommandInteraction
                                                                                                        .getUser())
                                                                                        .setTitle(String.format(
                                                                                                        "SGC POTW Report for %s from %s to %s",
                                                                                                        userBungieId,
                                                                                                        startDate.toString(),
                                                                                                        endDate.toString()))
                                                                                        .setDescription(String.format(
