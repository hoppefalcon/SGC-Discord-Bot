 ...
 */
public enum Raid {
    LAST_WISH("Last Wish", Arrays.asList("2122313384", "1661734046")),
    GARDEN_OF_SALVATION("Garden of Salvation", Arrays.asList("2659723068", "3458480158", "2497200493")),
    DEEP_STONE_CRYPT("Deep Stone Crypt", Arrays.asList("910380154", "3976949817")),
    VAULT_OF_GLASS("Vault of Glass", Arrays.asList("3881495763", "1485585878", "1681562271"));
