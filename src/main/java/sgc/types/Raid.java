...
public enum Raid {
        ...
        PANTHEON_CALUS_RESPLENDENT("The Pantheon: Calus Resplendent",
                        Arrays.asList("1516551982")),
        PANTHEON_MORGETH_SURPASSING("The Pantheon: Morgeth Surpassing",
                        Arrays.asList("2530656885")),
        PANTHEON_INSURRECTION_PRIME_REVOLUTIONARY("The Pantheon: Insurrection Prime Revolutionary",
                        Arrays.asList("747671496")),
        PANTHEON_FEATURED_MORGETH("Pantheon Encore: Morgeth",
                        Arrays.asList("43862588")),
        PANTHEON_FEATURED_WARPRIEST("Pantheon Encore: Warpriest",
                        Arrays.asList("145874766", "4147455553")),
        PANTHEON_FEATURED_INSURRECTION_PRIME("Pantheon Encore: Insurrection Prime",
                        Arrays.asList("206811036")),
        PANTHEON_FEATURED_CONSECRATED_MIND("Pantheon Encore: Consecrated Mind",
                        Arrays.asList("3975235718")),
        PANTHEON_REPRISE_ARGOS("Pantheon Reprise: Argos",
                        Arrays.asList("796488315")),
        PANTHEON_REPRISE_CALUS("Pantheon Reprise: Calus",
                        Arrays.asList("1566552947", "153253948")),
        PANTHEON_REPRISE_GAHLRAN("Pantheon Reprise: Gahlran",
        ...
        public static List<Raid> getRaidsOrdered() {
                ...
                raids.add(PANTHEON_CALUS_RESPLENDENT);
                raids.add(PANTHEON_MORGETH_SURPASSING);
                raids.add(PANTHEON_INSURRECTION_PRIME_REVOLUTIONARY);
                raids.add(PANTHEON_REPRISE_ARGOS);
                raids.add(PANTHEON_REPRISE_GAHLRAN);
                raids.add(PANTHEON_REPRISE_CALUS);
                raids.add(PANTHEON_FEATURED_MORGETH);
                raids.add(PANTHEON_FEATURED_WARPRIEST);
                raids.add(PANTHEON_FEATURED_CONSECRATED_MIND);
                raids.add(PANTHEON_FEATURED_INSURRECTION_PRIME);
                return raids;
        }
}
